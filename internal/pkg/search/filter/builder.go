...
type Builder interface {
	...
	From(field string, value *time.Time, include *bool)                        // По дате от
	To(field string, value *time.Time, include *bool)                          // По дате до
	Range(field string, from, to *time.Time, includeLower, includeUpper *bool) // Между
}
