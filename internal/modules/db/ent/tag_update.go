...
func (tu *TagUpdate) AddEventIDs(ids ...string) *TagUpdate {
...
func (tu *TagUpdate) RemoveEventIDs(ids ...string) *TagUpdate {
...
// AddEventIDs adds the "events" edge to the Event entity by IDs.
func (tuo *TagUpdateOne) AddEventIDs(ids ...string) *TagUpdateOne {
...
// RemoveEventIDs removes the "events" edge to Event entities by IDs.
func (tuo *TagUpdateOne) RemoveEventIDs(ids ...string) *TagUpdateOne {
