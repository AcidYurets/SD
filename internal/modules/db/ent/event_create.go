...
func (ec *EventCreate) SetIsWholeDay(b bool) *EventCreate {
	ec.mutation.SetIsWholeDay(b)
	return ec
}
...
func (ec *EventCreate) AddTagIDs(ids ...string) *EventCreate {
...
func (ec *EventCreate) AddInvitationIDs(ids ...string) *EventCreate {
	ec.mutation.AddInvitationIDs(ids...)
	return ec
}

// AddInvitations adds the "invitations" edges to the Invitation entity.
func (ec *EventCreate) AddInvitations(i ...*Invitation) *EventCreate {
...
func (ec *EventCreate) createSpec() (*Event, *sqlgraph.CreateSpec) {
	...
	if value, ok := ec.mutation.IsWholeDay(); ok {
		_spec.SetField(event.FieldIsWholeDay, field.TypeBool, value)
		_node.IsWholeDay = value
	}
	...
	if nodes := ec.mutation.InvitationsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
